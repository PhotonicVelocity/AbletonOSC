...
| /live/clip/get/warp_markers              | track_id, clip_id                                                   | track_id, clip_id, beat_time_1, sample_time_1, beat_time_2, sample_time_2, ...         | Get clip warp markers (pairs of beat_time, sample_time). Live includes a hidden marker ~1/32 beat after the last marker used to determine tempo.                      |
| /live/clip/add_warp_marker               | track_id, clip_id, beat_time [, sample_time]                        |                                                                                        | Add warp marker at beat time; if sample_time omitted, it is inferred from existing warp markers                                                                       |
| /live/clip/move_warp_marker              | track_id, clip_id, beat_time, beat_time_distance                    |                                                                                        | Move warp marker at beat time by beat_time_distance                                                                                                                   |
| /live/clip/remove_warp_marker            | track_id, clip_id, beat_time                                        |                                                                                        | Remove warp marker at beat time                                                                                                                                       |
